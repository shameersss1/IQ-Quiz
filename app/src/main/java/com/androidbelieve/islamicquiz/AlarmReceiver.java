...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context arg0, Intent arg1) {
        ...
        String name = prefs.getString("date", "");
       ...
       String date = dateFormat.format(new Date(System.currentTimeMillis()));
        ...
        String t= String.valueOf(checkBox);


        if(dayOfTheWeek.equals("Sunday") || name.equals(date) || t.equals(false))
        {
    ...
    private void login(final String phone, String answer, final Context arg0) {
        ...
        class LoginAsync extends AsyncTask<String, Void, String> {
            ...
            {
                buildNotification(arg0,"இன்றைய கேள்வி ரெடியா என Check பண்ண இங்கே கிளிக்");

            }
                else if(result.equals("1"))
            {
                buildNotification(arg0,"கேள்வி ரெடி, பதிலளிக்க இங்கே கிளிக்");
