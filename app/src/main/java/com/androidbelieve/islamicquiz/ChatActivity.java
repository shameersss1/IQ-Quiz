...
import com.androidbelieve.islamicquiz.adapter.ChatListAdapter;
import com.androidbelieve.islamicquiz.custom.BaseActivity;
import com.androidbelieve.islamicquiz.model.Conversation;
import com.androidbelieve.islamicquiz.utils.Const;
...
public class ChatActivity extends BaseActivity
{
    ...
    pushQuery.whereEqualTo("phone", "ADMIN");

String p = UserListActivity.user.getUsername().toString();
